...
#if SPMD_SPM_AT_SEL2
#define BL32_SIZE			0x300000
#define BL32_DRAM_LIMIT		(SEC_DRAM_BASE + BL32_SIZE)
#else
...
#if SPMD_SPM_AT_SEL2
# define HW_CONFIG_MEM_BASE		NS_DRAM0_BASE + 0x4000000
# define HW_CONFIG_MAX_SIZE		0x01000000
# define TOS_FW_CONFIG_MEM_BASE	SEC_SRAM_BASE + 0x1500
# define TOS_FW_CONFIG_MAX_SIZE	0xB00

#define NS_IMAGE_OFFSET		(NS_DRAM0_BASE + 0x30000000)
#define NS_IMAGE_MAX_SIZE		(NS_DRAM0_SIZE - 0x40000000)
#else
